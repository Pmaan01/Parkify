...
const Status = () => {
  ...
  useEffect(() => {
      ...
      if (urlParams.get('success') === 'true') {
        ...
        if (pending) {
          ...
          try {
            ...
            await axios.post('https://parkify-5cf7.onrender.com/api/confirmed-parking', {
    ...
    const fetchActiveSession = async () => {
      try {
        ...
        const res = await axios.get(
          'https://parkify-5cf7.onrender.com/api/confirmed-parking/active',
          {
            params: { userId },
          }
        );
    ...
    const fetchHistory = async () => {
      try {
        const userId = localStorage.getItem('userId');
        const res = await axios.get(
          'https://parkify-5cf7.onrender.com/api/confirmed-parking',
          {
            params: { userId },
          }
        );
  ...
  const handleEndParking = async () => {
    ...
    try {
      ...
      await axios.put(
        `https://parkify-5cf7.onrender.com/api/free-parking/${confirmedSpotId}`,
        {
          hasSpots: true,
          availableSpots: 1,
        }
      ...
      await axios.patch(
        `https://parkify-5cf7.onrender.com/api/confirmed-parking/${activeSession._id}/deactivate`
      );
